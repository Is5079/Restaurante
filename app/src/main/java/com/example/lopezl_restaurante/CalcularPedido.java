 ...
 * al pulsar el bot�n 'Calcular pedido' de la actividad principal.
 * 
 * 
 */
public class CalcularPedido extends Activity {
	...
	/**
	 * M�todo para calcular la cuenta de una mesa. Actividad lanzada al pulsar
	 * el bot�n 'Calcular total' de la actividad CalcularPedido.
	 * 
	 * 
	 * @throws RuntimeException
	 *             si el usuario no introduce ning�n n�mero de mesa.
	 */
	public void calcularTotalMesa(View view) throws RuntimeException {
		try {
			...
			sal.setText("Precio total: " + precioTotal + " Pesos");
	...
	/**
	 * M�todo para cobrar la cuenta de una mesa. Actividad lanzada al pulsar el
	 * bot�n 'Cobrar mesa' de la actividad CalcularPedido.
	 * 
	 * 
	 * @throws RuntimeException
	 *             si el usuario no introduce ning�n n�mero de mesa
