 ...
 * pulsar el bot�n 'Hacer reserva' de la actividad principal.
 * 
 * 
 */
public class Reservar extends Activity {
	...
	/**
	 * M�todo para hacer una reserva de un cliente en la base de datos.
	...
	public void crearReserva(View view) throws RuntimeException {
		...
		try {
			...
			// Comprobar que el n�mero de comensales est� dentro del rango
			// disponible
