...
/**
 * Clase para introducir las comandas de los clientes de una mesa. Se lanzar� al
 * pulsar el bot�n 'Hacer pedido' de la actividad principal.
 * 
 * 
 */
...
public class PedirPlatos extends Activity {
	...
	/**
	 * M�todo para introducir un pedido. Actividad lanzada al pulsar el bot�n
