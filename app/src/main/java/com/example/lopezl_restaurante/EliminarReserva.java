 ...
 * pulsar el bot�n 'Eliminar reserva' de la actividad principal.
 * 
 * 
 */
public class EliminarReserva extends Activity {
	...
	/**
	 * M�todo para mostrar la fecha de la reserva a eliminar introducida por el
	 * usuario.
	 * 
	 * @author 
	...
	/**
	 * M�todo para actualizar la fecha de la reserva a eliminar.
	 * 
	 * @author 
	 *         http://gdroid.com.mx/blog/2010/04/13/creacion-de-un-selector-de-fecha
	 *         -en-android/
	...
	/**
	 * M�todo para capturar la fecha de la reserva a eliminar introducida por el
	 * usuario.
	 * 
	 * @author 
	 *         http://gdroid.com.mx/blog/2010/04/13/creacion-de-un-selector-de-fecha
	...
	/**
	 * M�todo para eliminar una reserva de un cliente de la base de datos.
	 * Actividad lanzada al pulsar el bot�n 'Eliminar reserva' de la actividad
	 * EliminarReserva.
	 * 
	 * 
	...
	public void eliminarReserva(View view) throws RuntimeException {
		GestorBDRestaurante gbdRest = new GestorBDRestaurante(this, "platos", null, 1);
