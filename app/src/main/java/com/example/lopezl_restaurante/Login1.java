...
public class Login1 extends Activity implements OnClickListener {
    ...
    private static final String LOGIN_URL = "http://base12345.96.lt/login.php";
    ...
    class AttemptLogin extends AsyncTask<String, String, String> {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    SharedPreferences sp = PreferenceManager
                            .getDefaultSharedPreferences(Login1.this);
                    Editor edit = sp.edit();
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            if (file_url != null) {
                Toast.makeText(Login1.this, file_url, Toast.LENGTH_LONG).show();
            }
        }
    }
}